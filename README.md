...
[![My Skills](https://skillicons.dev/icons?i=react,redux,next,vue,nuxt,javascript,typescript,html,css,scss,bootstrap,docker,jest,webpack,python,postgresql,ruby,rails,markdown,figma,vscode,gitlab,github,netlify,vercel,heroku,bash,java)](https://skillicons.dev)
